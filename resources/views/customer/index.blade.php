...
<section class="section section-search">
	<div class="container-fluid">
		<div class="banner-wrapper">
			<img src="{{ asset('customer/assets/img/banner.jpg') }}" alt="">
		</div>
	</div>
</section>
<!-- /Home Banner -->
			...
			<div class="col-md-9">
				...
				<div class="specialities-slider slider">
					...
					<?php foreach ($services as $key => $value): ?>
						<!-- Slider Item -->
						<a href="{{ route('customer.service', ['slug' => $value->slug]) }}" class="speicality-item text-center">
							<div class="speicality-img">
								<img src="{{ asset($value->image) }}" class="img-fluid" alt="Speciality">
			...
			<div class="col-lg-8">
				<div class="doctor-slider slider">
					...
					<div class="profile-widget">
						<div class="doc-img">
							<a href="doctor-profile.html">
								<img class="img-fluid" alt="User Image" src="customer/assets/img/doctors/doctor-06.jpg">
							</a>
							<a href="javascript:void(0)" class="fav-btn">
								<i class="far fa-bookmark"></i>
							</a>
					...
					<div class="profile-widget">
						<div class="doc-img">
							<a href="doctor-profile.html">
								<img class="img-fluid" alt="User Image" src="customer/assets/img/doctors/doctor-07.jpg">
							</a>
							<a href="javascript:void(0)" class="fav-btn">
								<i class="far fa-bookmark"></i>
							</a>
					...
					<div class="profile-widget">
						<div class="doc-img">
							<a href="doctor-profile.html">
								<img class="img-fluid" alt="User Image" src="customer/assets/img/doctors/doctor-08.jpg">
							</a>
							<a href="javascript:void(0)" class="fav-btn">
								<i class="far fa-bookmark"></i>
							</a>
